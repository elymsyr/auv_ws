...
class NonlinearMPC {
public:
    NonlinearMPC(const rclcpp::Logger& logger, std::string modelPath = "/models/fossen_net_1/fossen_net_scripted.pt", std::string scalerPath = "/models/fossen_net_1/scalers.json");
